    ...
    int countStudents(vector<int>& students, vector<int>& sandwiches) {
        ...
        for (int x : sandwiches) {
            ...
            if (x) {
                ...
                if (count1 > 0) {
                    count1--; // Reduce the count of students preferring this
                              // type of sandwich
                } else {
                    // If no students prefer this type of sandwich, return the
                    // count of students unable to eat
                    return count0;
                }
            } else {
                ...
                // If there are still students who prefer this type of sandwich
                if (count0 > 0) {
                    count0--; // Reduce the count of students preferring this
                              // type of sandwich
                } else {
                    // If no students prefer this type of sandwich, return the
                    // count of students unable to eat
